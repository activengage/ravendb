...
namespace Raven35.Abstractions.Json
{
    public class JsonDateTimeOffsetConverter : RavenJsonConverter
    {
        ...
        /// </summary>
        /// <param name="writer">The <see cref="T:Raven35.Imports.Newtonsoft.Json.JsonWriter"/> to write to.</param><param name="value">The value.</param><param name="serializer">The calling serializer.</param>
        ...
        /// </summary>
        /// <param name="reader">The <see cref="T:Raven35.Imports.Newtonsoft.Json.JsonReader"/> to read from.</param><param name="objectType">Type of the object.</param><param name="existingValue">The existing value of object being read.</param><param name="serializer">The calling serializer.</param>
        /// <returns>
        /// The object value.
        /// </returns>
