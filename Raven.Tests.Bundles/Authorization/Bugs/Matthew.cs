    ...
    public class Matthew : AuthorizationTest
    {
        ...
        public void AuthorizationDemo_Works()
        {
            ...
            using (IDocumentSession session = store.OpenSession(DatabaseName))
            {
                ...
                client::Raven35.Client.Authorization.AuthorizationClientExtensions.SetAuthorizationFor(session, maryMallon,
            ...
            using (IDocumentSession session = store.OpenSession(DatabaseName))
            {
                client::Raven35.Client.Authorization.AuthorizationClientExtensions.SecureFor(session,
